...
const ProcessApiAxiosParamCreator = function (configuration) {
    return {
        ...
        connectPtySession: async (sessionId, options = {}) => {
            ...
            const localVarPath = `/process/pty/{sessionId}/connect`.replace(`{${'sessionId'}}`, encodeURIComponent(String(sessionId)));
        ...
        deleteSession: async (sessionId, options = {}) => {
            ...
            const localVarPath = `/process/session/{sessionId}`.replace(`{${'sessionId'}}`, encodeURIComponent(String(sessionId)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, common_1.DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
        ...
        resizePtySession: async (sessionId, request, options = {}) => {
            ...
            const localVarPath = `/process/pty/{sessionId}/resize`.replace(`{${'sessionId'}}`, encodeURIComponent(String(sessionId)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, common_1.DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
        ...
        sessionExecuteCommand: async (sessionId, request, options = {}) => {
            ...
            const localVarPath = `/process/session/{sessionId}/exec`.replace(`{${'sessionId'}}`, encodeURIComponent(String(sessionId)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, common_1.DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
...
class ProcessApi extends base_1.BaseAPI {
     ...
     */
    connectPtySession(sessionId, options) {
        return (0, exports.ProcessApiFp)(this.configuration)
            .connectPtySession(sessionId, options)
